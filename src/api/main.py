...
app = FastAPI(
    ...
    description="Lead generation agent that identifies potential customers from multiple data sources, scores leads by fit and intent, enriches contact data, and feeds qualified leads into the sales pipeline.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
