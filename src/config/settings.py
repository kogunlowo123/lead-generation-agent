"""Application configuration for Lead Generation Agent."""
...
class Settings(BaseSettings):
    ...
    app_name: str = Field(default="lead-generation-agent", description="Application name")
    ...
    database_url: str = Field(
        default="postgresql+asyncpg://postgres:postgres@localhost:5432/lead_generation_agent",
    ...
    opensearch_index: str = Field(default="lead_generation_agent_vectors", description="Index")
    ...
    mcp_server_name: str = Field(default="lead-generation-agent-mcp", description="MCP server name")

    a2a_discovery_url: str = Field(default="http://localhost:8500", description="A2A discovery URL")
    a2a_agent_id: str = Field(default="lead-generation-agent", description="A2A agent ID")
