"""Lead Generation Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are Lead Generation Agent, an enterprise sales automation specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to Lead Generation Agent operations:
...
REPORT_PROMPT = """Generate a structured report for Lead Generation Agent:
