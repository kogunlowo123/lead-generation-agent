"""Lead Generation Agent - Domain-Specific Connectors."""
...
class SalesforceConnector:
    """Domain-specific connector for salesforce integration with Lead Generation Agent."""
...
class HubspotConnector:
    """Domain-specific connector for hubspot integration with Lead Generation Agent."""
...
class OutreachConnector:
    """Domain-specific connector for outreach integration with Lead Generation Agent."""
...
class ApolloConnector:
    """Domain-specific connector for apollo integration with Lead Generation Agent."""
...
class LinkedinSalesNavigatorConnector:
    """Domain-specific connector for linkedin sales navigator integration with Lead Generation Agent."""
